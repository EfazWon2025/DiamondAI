...
const FeatureCard: React.FC<{ icon: IconName; platform: string; description: string; versions: string; color: string }> = ({ icon, platform, description, versions, color }) => (
