...
import { ZoomInIcon, ZoomOutIcon, SearchIcon, FileCodeIcon } from '../icons/IdeIcons';
    ...
    return (
        <div className="w-full">
            <div className="w-full h-64 flex items-center justify-center bg-darker rounded-lg overflow-hidden p-4">
                <div 
                    ...
                    style={{
                        ...
                        backgroundImage: `url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABYSURBVDhPnYy7DcAgDAMx/v/P7gQSk1pwKsmgEC5HhmAFWjBCO2jAWrTgnHED3pTiA3a+xAP0iJ8f4b0fsZ8f8e/x+MH4fB4fE+9n/K8/Gg9Y6crpEy2wDAAAAABJRU5ErkJggg==)`,
            ...
            <div className="flex items-center gap-2 mt-2">
                <button onClick={() => setZoom(z => Math.max(1, z - 1))} className="p-1 bg-darker rounded hover:bg-secondary/30"><ZoomOutIcon className="w-4 h-4" /></button>
                <input 
                    type="range" 
                    min="1" max="20" value={zoom} 
                    onChange={e => setZoom(Number(e.target.value))}
                    className="w-full h-1 bg-darker rounded-lg appearance-none cursor-pointer"
                />
                <button onClick={() => setZoom(z => Math.min(20, z + 1))} className="p-1 bg-darker rounded hover:bg-secondary/30"><ZoomInIcon className="w-4 h-4" /></button>
    ...
    return (
        <aside className="w-full h-full bg-dark flex flex-col border-l border-secondary/10">
            ...
            <div className="flex-grow p-4 overflow-y-auto">
                ...
                {activeFile && activeFile.fileType === 'json' && (
                    <div>
                ...
                {activeFile && activeFile.fileType === 'png' && (
                     <div>
                ...
                {activeFile && !['json', 'png'].includes(activeFile.fileType || '') && (
                     <div className="h-full flex flex-col items-center justify-center text-center text-light-text">
                        <FileCodeIcon className="w-24 h-24 text-secondary/10 mx-auto"/>
