...
export const BugIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M20 8h-4.3a5 5 0 0 0-9.4 0H2"></path>
        <path d="m20 16-2-3-2 3M2 16l2-3 2 3"></path>
        <path d="M12 20v-4"></path>
        <path d="M12 4V2"></path>
        <path d="m15 7-1-1-1 1M9 7l1-1 1 1"></path>
    </svg>
);
...
export const HammerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m15 12-8.373 8.373a2.828 2.828 0 1 1-4-4L12 8" />
        <path d="M18 15 6 3" />
    </svg>
);
...
export const JavaIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path>
    <polyline points="14 2 14 8 20 8"></polyline>
    <path d="M12 18v-6"></path><path d="M12 18h-2.5"></path>
    <path d="M12 12a2.5 2.5 0 0 1-2.5 2.5"></path>
    <path d="M12 12a2.5 2.5 0 0 0 2.5-2.5"></path>
  </svg>
);

export const JsonIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M20 16.5c.5-.83.5-1.83 0-2.66l-4-6.67c-.5-.83-1.5-.83-2 0l-4 6.67c-.5.83-.5 1.83 0 2.66l4 6.67c.5.83 1.5.83 2 0l4-6.67z"/>
        <path d="M12 8v8"/>
    </svg>
);
...
export const PngIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M21.2 15c.7-1.2 1-2.5.7-3.9-.6-2.4-3.4-4.3-6.4-4.3-1.2 0-2.3.5-3.2 1.2"/>
        <path d="M10 12.5c.7-1.2 1-2.5.7-3.9-.6-2.4-3.4-4.3-6.4-4.3-1.2 0-2.3.5-3.2 1.2"/>
        <path d="m6.5 18.8.9-1.3c.5-.7 1.3-1.2 2.1-1.2H12"/>
        <path d="m17.5 18.8-.9-1.3c-.5-.7-1.3-1.2-2.1-1.2H8"/>
        <path d="M16 12.5a2.5 2.5 0 0 1-1.3 2.2"/>
        <path d="M8 12.5a2.5 2.5 0 0 0 1.3 2.2"/>
    </svg>
);

export const GradleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M22 13V8.81a2.51 2.51 0 0 0-1.88-2.36l-7.23-3.1a2.51 2.51 0 0 0-1.78 0l-7.23 3.1A2.51 2.51 0 0 0 2 8.81V13"/>
        <path d="M11 12.5a2.5 2.5 0 0 1 2 0l7.23 3.1a2.5 2.5 0 0 1 1.77 2.36V20a2 2 0 0 1-2 2H3.88a2 2 0 0 1-2-2v-1.23a2.5 2.5 0 0 1 1.77-2.36l7.23-3.1a2.5 2.5 0 0 1 2.12 0Z"/>
    </svg>
);
...
export const HandleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const PuzzleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M14 10V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h2a2 2 0 0 1 2 2v4a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-2z" />
        <path d="M4 14v-4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-2a2 2 0 0 0-2 2v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z" />
    </svg>
);
...
export const PencilIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M7.5 20.5 19 9l-4-4L3.5 16.5 2 22l5.5-1.5z"></path>
    </svg>
);
